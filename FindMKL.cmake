...
if (NOT MKL_ROOT_DIR)
	...
	if (EXISTS "${MKL_ROOT_DIR}/bin/mkl_link_tool")
		...
		if ((IS_DIRECTORY "${MKL_ROOT_DIR}/bin/mkl_link_tool") AND (EXISTS "${MKL_ROOT_DIR}/bin/mkl_link_tool/mkl_link_tool"))
			set(MKL_LINK_TOOL "${MKL_ROOT_DIR}/bin/mkl_link_tool/mkl_link_tool")
		else ()
			set(MKL_LINK_TOOL "${MKL_ROOT_DIR}/bin/mkl_link_tool")
		endif ()
	elseif (EXISTS "${MKL_ROOT_DIR}/bin/intel64/mkl_link_tool")
		set(MKL_LINK_TOOL "${MKL_ROOT_DIR}/bin/intel64/mkl_link_tool")
	elseif (EXISTS "${MKL_ROOT_DIR}/bin/ia32/mkl_link_tool")
		set(MKL_LINK_TOOL "${MKL_ROOT_DIR}/bin/ia32/mkl_link_tool")
	...
	message("Link Tool = ${MKL_LINK_TOOL_COMMAND}")
